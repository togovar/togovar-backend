...
class SequenceOntology < TermDictionary
  module VariantClass
    ...
    SO_0000667 = TermDictionary::Term.new('SO_0000667', :ins, 'INS')
    SO_0000159 = TermDictionary::Term.new('SO_0000159', :del, 'DEL')
    SO_1000032 = TermDictionary::Term.new('SO_1000032', :indel, 'INDEL')
    SO_1000002 = TermDictionary::Term.new('SO_1000002', :sub, 'MNV')
    SO_1000035 = TermDictionary::Term.new('SO_1000035', :dup, 'DUP')
    SO_1000036 = TermDictionary::Term.new('SO_1000036', :inv, 'INV')
    SO_0001021 = TermDictionary::Term.new('SO_0001021', :bnd, 'BND')
  end
  include VariantClass

  module VariantConsequence
    ...
    SO_0001787 = TermDictionary::Term.new('SO_0001787', :splice_donor_5th_base_variant, 'Splice donor 5th base variant')
    SO_0001630 = TermDictionary::Term.new('SO_0001630', :splice_region_variant, 'Splice region variant')
    SO_0002170 = TermDictionary::Term.new('SO_0002170', :splice_donor_region_variant, 'Splice donor region variant')
    SO_0002169 = TermDictionary::Term.new('SO_0002169', :splice_polypyrimidine_tract_variant, 'Splice polypyrimidine tract variant')
    SO_0001626 = TermDictionary::Term.new('SO_0001626', :incomplete_terminal_codon_variant, 'Incomplete terminal codon variant')
    ...
    SO_0001792 = TermDictionary::Term.new('SO_0001792', :non_coding_transcript_exon_variant, ' Non coding transcript exon variant')
    ...
    SO_0001968 = TermDictionary::Term.new('SO_0001968', :coding_transcript_variant, 'Coding transcript variant')
    ...
    SO_0001891 = TermDictionary::Term.new('SO_0001891', :regulatory_region_amplification, 'Regulatory region amplification')
    ...
    SO_0001060 = TermDictionary::Term.new('SO_0001060', :sequence_variant, ' Sequence variant')
  end
  include VariantConsequence

  CONSEQUENCES_IN_ORDER = [SO_0001893, SO_0001574, SO_0001575, SO_0001587, SO_0001589, SO_0001578, SO_0002012,
                           SO_0001889, SO_0001907, SO_0001906, SO_0001821, SO_0001822, SO_0001583, SO_0001818,
                           SO_0001787, SO_0001630, SO_0002170, SO_0002169, SO_0001626, SO_0002019, SO_0001567,
                           SO_0001819, SO_0001580, SO_0001620, SO_0001623, SO_0001624, SO_0001792, SO_0001627,
                           SO_0001621, SO_0001619, SO_0001968, SO_0001631, SO_0001632, SO_0001895, SO_0001892,
                           SO_0001782, SO_0001894, SO_0001891, SO_0001566, SO_0001628, SO_0001060].freeze
